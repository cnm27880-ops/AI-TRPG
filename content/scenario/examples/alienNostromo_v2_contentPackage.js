...
export default {
  ...
  "conversionStatus": "content_only_with_approved_exploration_gap_major_variants_clue_presentations_and_luyuan_ripley_npc_cooperation_pilots",
  "safetyNote": "本資料只提供玩家可見敘事、轉場旁白、已接觸 NPC 的語氣素材、依 canonical result 綁定的線索演出，以及 server-only 的陸遠／Ripley 協作 overlay；canonical reference 與 engine effects 仍是唯一真相。重大場景、clue 與 NPC cooperation overlay 不得自行新增傷勢、物品、位置、門狀態、威脅、旗標、NPC 狀態、死亡、結局或獎勵。",
