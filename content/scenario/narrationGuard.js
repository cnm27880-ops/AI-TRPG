...
const RULES = Object.freeze([
  ...
  },
  {
    ...
    regexes: [
      /(?:取得|拿到|獲得|撿起|撿到|拾起|遺失|掉落|摔落|損壞|破損|變形|彎曲|斷裂|失效|消耗|用完).{0,16}(?:手電筒|工具|扳手|撬棍|焊槍|樣本|組織|裝備|武器|手槍|沙漠之鷹|物品)/,
      /(?:手電筒|工具|扳手|撬棍|焊槍|樣本|組織|裝備|武器|手槍|沙漠之鷹|物品).{0,16}(?:遺失|掉落|摔落|損壞|破損|變形|彎曲|斷裂|失效|消耗|用完)/,
    ],
  },
  {
