  ...
  entries: [
    {
      ...
      openingNarration: `微光從你的肩膀、胸口和膝蓋依次退去，像一層被船艦吸回去的薄膜。最後一點亮色沉入地板接縫，休眠室裡只剩下冷卻系統的低鳴。

七座休眠艙沿著牆面排列。六座艙蓋停在打開的位置，內部沒有活人的反應；其中一座的固定帶被扯斷，艙沿留著暗褐色的乾涸痕跡。冷白燈每隔幾秒短暫失電，黑暗回來時，門外傳進來的不是腳步，而是某種重量沿著金屬結構移動的細響。

你手背上的醫療貼片亮起一行小字：WEYLAND-YUTANI ／ USCSS NOSTROMO。灰色工作服的袖口有反覆磨損的折痕，口袋裡沒有識別證，也沒有能說明你為什麼在這裡的私人用品。

擴音器突然恢復電力。MU-TH-UR 6000 用平穩得近乎無機質的聲音要求全體船員前往 A 甲板橋樓。第一遍結束後，系統沒有立刻斷線；它保留著一段等待回覆的靜默，接著又從頭播報。

休眠室通往服務走廊的艙門卡在半開的位置。門檻外有一道被拖過的痕跡，穿過閃爍的照明，消失在 A 甲板方向。痕跡旁的手電筒仍然亮著，光束照出幾滴尚未乾透的黏液。

通風管內傳來一下沉悶的受壓聲。不是回音，也不像船體自然收縮。聲音停下來之後，整艘船像是在等你先做出決定。`,
