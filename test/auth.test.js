...
//   - 搶奪別人已經認領過的存檔
//
// Discord OAuth2 流程本身（state/PKCE、跟 Discord 換 token、使用者資料正規化）
// 的測試在 test/discordAuth.test.js，這裡只測登入票簽發之後、跟存檔歸屬有關的部分。
import test from "node:test";
import assert from "node:assert/strict";
import { base64UrlEncode } from "../content/auth/pkce.js";
import {
  signSessionToken,
  verifySessionToken,
  readCookie,
