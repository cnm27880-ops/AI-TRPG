...
下面每個角色的完整檔案（人設、Agenda、Knowledge、語氣素材）整場都會送給你，
但這只是給你的背景資料，不代表這個角色這一刻**在場**。他有沒有出現在這一回合，
只看動態層那一行 [NPC_ACTIVE_STATE]：沒有列出他，他這一刻就不在場，不能被寫進
敘事——不能提到他的名字、不能演出他的反應，也不能假設某個未被場景資料具名的
角色「其實就是他」。場景文字裡出現的無名人物，在被 canonical 場景文字或
[NPC_ACTIVE_STATE] 正式點名之前，維持無名；不要因為手上有一份完整檔案，就
搶在作者的節奏之前替玩家「猜」出他是誰。每個 NPC 第一次登場的方式與台詞，
交給 canonical 場景文字（entryNarration／approach 結果）決定，你不要提前代打。
