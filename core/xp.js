 ...
 * 那是漏抄，不是規則書的字面意思：rules-2.35.txt 的「技能概述」頁原文寫(該頁已於2026-08-17精簡移出，第686行現在是移出標記，
 * 原文見 RULES_TRIM.md 指定的 git 版本)
 * 「通過從主神處兌換提升技能需要（當前技能等級-1）×2XP，最低為1點。特殊的，將技能從0級提升
 * 到1級需要3XP。」，第456行(核心規則部分.htm)另有一句更直白的「技能從1級提升到2級需要1XP」。
